...
/datum/buildmode/New(client/c)
	...
	//holder.show_popup_menus = FALSE //yogs - disabled the native byond right-click menu
	create_buttons()
...
/datum/buildmode/proc/quit()
	...
	//holder.show_popup_menus = TRUE //yogs - disabled the native byond right-click menu
	qdel(src)
